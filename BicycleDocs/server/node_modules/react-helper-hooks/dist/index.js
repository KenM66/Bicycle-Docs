...
function useAsync(callback, dependencies) {
  ...
  var callbackMemoized = react.useCallback(function () {
    setLoading(true);
    setError(undefined);
    setValue(undefined);
...
function useDebounce(callback, delay, dependencies) {
  ...
  react.useEffect(reset, [].concat(dependencies, [reset]));
  react.useEffect(clear, []);
}

function useUpdateEffect(callback, dependencies) {
  var firstRendererRef = react.useRef(true);
  react.useEffect(function () {
...
function usePrevious(value) {
  var currentRef = react.useRef(value);
...
exports.useIsAppOffline = useIsAppOffline;
